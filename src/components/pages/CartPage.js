  ...
  return (
    <div
      ...
      style={{
        ...
        height: "22px",
        borderRadius: "6px",
        border: checked ? "none" : "2.5px solid var(--border)",
        backgroundColor: checked ? "#ee6c00" : "transparent",
        display: "flex",
        alignItems: "center",
            ...
            return (
              <div key={pharmacyId} className="order-group-box" style={{ border: "1px solid var(--border)", borderRadius: "16px", padding: "16px", backgroundColor: "var(--surface)", display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    ...
                    <div style={{
                      ...
                      <span style={{ fontSize: "20px" }}>{pharmacyLogo}</span>
                    </div>

                    {/* Pharmacy Info */}
                    <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                      <span style={{ fontSize: "15px", fontWeight: "700", color: "#0c2b5c" }}>
                        {pharmacyName}
                      </span>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "13px", borderTop: "1px solid var(--border)", paddingTop: "10px", fontWeight: "700", flexWrap: "wrap", gap: "8px" }}>
                  <div>
                    <span style={{ color: "var(--text-2)", fontWeight: "600" }}>{language === "ar" ? "رسوم التوصيل: " : "Delivery Fee: "}</span>
          ...
          <div style={{ backgroundColor: "var(--surface)", border: "1px solid var(--border)", borderRadius: "16px", padding: "20px", display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <button
              ...
              style={{
                width: "100%",
                marginTop: "8px",
                backgroundColor: selectedPharmacyIds.length === 0 ? "var(--border)" : "var(--primary)",
                color: selectedPharmacyIds.length === 0 ? "var(--text-2)" : "var(--text-on-primary)",
                cursor: selectedPharmacyIds.length === 0 ? "not-allowed" : "pointer"
              }}
            >
